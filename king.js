...
async function sessdl() {
  try {
    ...
    const base64Data = sess.SESSION_ID.split("KING-PRO~")[1];
    if (!base64Data) {
...
async function connectToWA() {
  ...
  //===========================
  console.log("🥷𝐊𝐢𝐧𝐠 𝐑𝐀𝐍𝐔𝐗ᵖʳᵒ🔥 is starting...");
  ...
  conn.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("📥Download Bot File And Plugin Successful... ");
      console.log("Servers Connect To Whatsapp 🚀");
      // Assuming `config` contains all the settings
      let up = `
          🥷𝐊𝐢𝐧𝐠 𝐑𝐀𝐍𝐔𝐗ᵖʳᵒ🔥 Successfully Connected! ✨🚀

🎉💖 Welcome to the Official 🚀 𝐊𝐢𝐧𝐠 𝐑𝐀𝐍𝐔𝐗ᵖʳᵒ🔥 Bot! 💖🎉  
Your powerful WhatsApp assistant is now online ⚡🤖
...
🎙️ AUTO RECORDING: ${config.AUTORECORDING ? "Enabled" : "Disabled"}

🫂🙏 Thank you for choosing ©𝐊𝐢𝐧𝐠 𝐑𝐀𝐍𝐔𝐗ᵖʳᵒ🔥  
We’re always here to level up your WhatsApp experience! 🚀  
...
Enjoy using your bot! 😇💫`;
      ...
      conn.sendMessage(conn.user.id, {
        text: up,
        contextInfo: {
          mentionedJid: ["94726880784@s.whatsapp.net"], // specify mentioned JID(s) if any
          groupMentions: [],
          forwardingScore: 999,
          isForwarded: true,
          forwardedNewsletterMessageInfo: {
            newsletterJid: "120363402596195345@newsletter",
            newsletterName: "© 𝐊𝐢𝐧𝐠 𝐑𝐀𝐍𝐔𝐗ᵖʳᵒ🔥",
            serverMessageId: 999,
          },
          externalAdReply: {
            title: "© 𝐊𝐢𝐧𝐠 𝐑𝐀𝐍𝐔𝐗ᵖʳᵒ🔥",
            body: " ©𝓜𝓡. 𝓡𝓪𝓷𝓼𝓪𝓻𝓪 𝓓𝓮𝓿𝓷𝓪𝓽𝓱",
            mediaType: 1,
            sourceUrl: "https://github.com/bot-create4",
            thumbnailUrl:
              "https://raw.githubusercontent.com/rasara4/dp-project-1/refs/heads/main/images/1762859117583.jpg", // This should match the image URL provided above
